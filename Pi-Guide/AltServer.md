...
If you still can't get this to work, I would recommend using SideStore instead. Otherwise, you can try the dockerized version of AltServer for Linux: https://github.com/dreth/Altserver-docker
