...
5. Disconnect your device from the Pi, and run `netmuxd`:
    ...
    ```
    - You should see an output like this if it's successful. Ideally, nothing else should be outputing after "Adding device ...", but if it keeps saying "Adding device..." and "Removing device...", restart the Pi and try again.
        ```
        Starting netmuxd
